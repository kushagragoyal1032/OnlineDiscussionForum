...
<div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="/forum/partials/handle_signup.php">  
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputAge" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword2" name="user_cpass"
                            aria-describedby="emailHelp" required>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit" value="sign-in">Sign Up</button>
                </div>
            </form>
        </div>
    </div>
